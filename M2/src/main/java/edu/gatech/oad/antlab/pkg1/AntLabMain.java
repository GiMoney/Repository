...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Gi Suen");
        toPrint += p1.toString("903197685");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Daniella Ruzinov");
        toPrint += p2.toString("903445398");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Brian Lin");
        toPrint += p3.toString("903198059");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Lincoln Anders");
        toPrint += p4.toString("903361154");
